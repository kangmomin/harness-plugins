---
name: fe-harness__doctor
description: "fe-harness 플러그인의 모든 의존성 상태를 한 번에 진단한다."
...
| TypeScript 컴파일 | profile의 `typeCheckCommand` dry-run | lint-check |
...
| 항목 | 상태 | 비고 |
|------|------|------|
| .claude/fe-harness.local.md | OK / MISSING | 없으면 /fe-harness:init 실행 필요 |
...
| .claude/fe-harness.local.md | **필수** | 플러그인 설정 |
