---
name: be-harness__submit-feedback
...
- `.claude/be-harness/common.md`
- `.claude/be-harness/skills/submit-feedback.md`
...
**출처**: /be-harness:start-workflow Phase 8 성찰
...
git commit -m "Add: be-harness community-feedback — {요약}"
```
...
## 출처
- 워크플로우: /be-harness:start-workflow Phase 8 성찰 (자동 제출)
