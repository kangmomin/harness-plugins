...
- 신규 작성: `/workspace/work-log/claude/YYYYMMDD-<kebab-case-subject>-api-test-cases.html`
- 이전 단순화 문서의 정정본: `/workspace/work-log/claude/YYYYMMDD-<kebab>-api-test-cases-honest.html` 또는 `-corrected.html`
...
저장 위치: /workspace/work-log/claude/...html
```
