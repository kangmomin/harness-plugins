...
> **Project Overrides**: 실행 전 `.claude/fe-harness/common.md`와 `.claude/fe-harness/skills/convention-check.md`를 Read.
...
`.claude/fe-harness.local.md`의 `componentPattern`에 따라:
