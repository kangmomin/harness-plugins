...
BE Build는 [review-evidence.md](review-evidence.md)의 check-scope와 check-current --require scope를 반영 직전 다시 통과한다. staged 변경과 보존 artifact 손상·유실도 재수집/독립 보완 대상이며 테스트 PASS만으로 대신하지 않는다.
