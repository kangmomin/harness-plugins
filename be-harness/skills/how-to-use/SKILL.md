...
> **Project Overrides**: 실행 전 `.claude/be-harness/common.md`와 `.claude/be-harness/skills/how-to-use.md`를 Read.
...
어떤 스킬의 사용법이 궁금하신가요?
 ...
 1. /request — 작업 유형별 단계적 질문을 통해 Technical Spec 생성
 2. /convention-check — 컨벤션 위반 검사 및 보고
 ...
```
